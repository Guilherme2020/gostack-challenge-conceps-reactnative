...
Nesse desafio, foi criada uma aplicação para treinar o aprendizado inicial em React Native!

Foi desenvolvida uma aplicação que armazena repositórios, que desenvolvi  no backend utilizando o Node.js.
...
Para esse desafio foi usado os seguintes testes:
